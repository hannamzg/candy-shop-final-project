...
<head>
    ...
    <title>Class Management - Church Management</title>
...
<body>
    ...
    <div class="page-container">
        <div class="page-header">
            ...
            <p>Manage your church classes and educational content</p>
        </div>
            ...
            <div class="form-card">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="priority" id="priority" min="1" required placeholder="1" value="1">
                        <small style="color: #6c757d; font-size: 0.8rem;">Lower numbers appear first</small>
                    </div>
                ...
                <div style="overflow-x: auto;">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            $sql_content = "SELECT * FROM classpage WHERE client_id = $clientID ORDER BY priority ASC, id DESC";
                            ...
                            if ($result_content->num_rows > 0) {
                                while ($row = $result_content->fetch_assoc()) {
                                    ...
                                    echo "</td>";
                                    echo "<td><span style='background: #667eea; color: #fff; padding: 4px 8px; border-radius: 4px; font-size: 0.8rem;'>" . htmlspecialchars($row["priority"]) . "</span></td>";
                                    echo "<td>";
                                    echo "<div class='action-buttons'>";
                                    echo "<a href='editClass.php?id=" . $row['id'] . "' class='btn btn-success btn-sm'>";
                                ...
                                echo "<p>Start by adding some class content using the form on the left.</p>";
                                echo "</div>";
                                echo "</td></tr>";
                            }
                            ?>
