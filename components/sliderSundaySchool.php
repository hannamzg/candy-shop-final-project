<div class="container" style="direction: rtl;">
  <h2 style="font-family: Arial, sans-serif; color: #333;  margin: 20px auto;">فعاليات مدرسة الأحد الأسبوعية</h2>

  <!-- Swiper container -->
  <swiper-container class="mySwiper" space-between="30" slides-per-view="auto" pagination="true" pagination-clickable="true">
    <?php
    // Fetch content from the database
    $sql = "SELECT * FROM `content` WHERE pageID = 8 AND client_id = $clientID ORDER BY id DESC"; 
            ...
            echo '<swiper-slide style="width: 300px;">
                    <div class="card" style="width: 100%; margin: 10px; background: white; border: 1px solid #ccc; border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
                        ...
                        <div class="card-body" style="padding: 15px;">
                            ...
                            <a href="eventSundaySchool.php?id=' . $row['id'] . '" class="btn" style="display: inline-block; padding: 10px 15px; font-size: 14px; color: white; background-color: #007bff; border: none; border-radius: 5px; text-decoration: none; text-align: center;">المزيد من المعلومات</a>
                        </div>
                    </div>
                  </swiper-slide>';
        }
